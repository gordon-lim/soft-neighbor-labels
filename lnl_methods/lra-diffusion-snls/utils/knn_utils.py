...
# This code was generated with the help of ChatGPT based on my idea for implementing
# soft k-NN label sampling, where neighbors' labels are weighted by frequency
